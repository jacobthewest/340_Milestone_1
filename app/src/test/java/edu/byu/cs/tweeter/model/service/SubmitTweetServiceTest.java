...
public class SubmitTweetServiceTest {
    ...
    @Test
    public void testGetCount_invalidRequest_userDoesNotMatchStatus() throws IOException {
        SubmitTweetResponse response = submitTweetServiceSpy.submitTweet(invalidRequest1);
        Assertions.assertEquals(failureResponse, response);
    }

    @Test
    public void testGetCount_invalidRequest_userIsNull() throws IOException {
        SubmitTweetResponse response = submitTweetServiceSpy.submitTweet(invalidRequest2);
        Assertions.assertEquals(failureResponse, response);
    }

    @Test
    public void testGetCount_invalidRequest_statusIsNull() throws IOException {
