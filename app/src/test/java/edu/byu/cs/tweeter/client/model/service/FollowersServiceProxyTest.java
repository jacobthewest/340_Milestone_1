...
public class FollowersServiceProxyTest {
    ...
    public void setup() {
        ...
        // Create a FollowersService instance and wrap it with a spy that will use the mock edu.byu.cs.server.edu.byu.cs.tweeter.server.edu.byu.cs.shared.edu.byu.cs.tweeter.shared.model.edu.byu.cs.tweeter.server.service
