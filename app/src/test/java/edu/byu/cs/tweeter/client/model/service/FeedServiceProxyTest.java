...
public class FeedServiceProxyTest {
    ...
    public void setup() {
        ...
        // Create a FeedService instance and wrap it with a spy that will use the mock edu.byu.cs.server.edu.byu.cs.tweeter.server.edu.byu.cs.shared.edu.byu.cs.tweeter.shared.model.edu.byu.cs.tweeter.server.service
    ...
    public void testGetFeed_invalidRequest_nullUser() throws IOException {
        FeedResponse response = feedServiceProxySpy.getFeed(invalidRequestOne);
        Assertions.assertEquals(failureResponse, response);
    }

    @Test
    public void testGetFeed_invalidRequest_negativeLimit() throws IOException {
        FeedResponse response = feedServiceProxySpy.getFeed(invalidRequestTwo);
        Assertions.assertEquals(failureResponse, response);
    }
