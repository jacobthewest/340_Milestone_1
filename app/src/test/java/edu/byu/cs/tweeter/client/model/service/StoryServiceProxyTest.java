...
public class StoryServiceProxyTest {
    ...
    public void setup() {
        ...
        // Create a StoryService instance and wrap it with a spy that will use the mock edu.byu.cs.server.edu.byu.cs.tweeter.server.edu.byu.cs.shared.edu.byu.cs.tweeter.shared.model.edu.byu.cs.tweeter.server.service
    ...
    public void testGetStory_invalidRequest_nullUser() throws IOException {
        StoryResponse response = storyServiceProxySpy.getStory(invalidRequestOne);
        Assertions.assertEquals(failureResponse, response);
    }

    @Test
    public void testGetStory_invalidRequest_negativeLimit() throws IOException {
        StoryResponse response = storyServiceProxySpy.getStory(invalidRequestTwo);
        Assertions.assertEquals(failureResponse, response);
    }
