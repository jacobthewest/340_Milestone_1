...
public class RetrieveUserPresenterTest {
    ...
    private RetrieveUserServiceProxy mockRetrieveUserServiceProxy;
    ...
    public void setup() {
        ...
        mockRetrieveUserServiceProxy = Mockito.mock(RetrieveUserServiceProxy.class);
        ...
        Mockito.when(presenter.getRetrieveUserService()).thenReturn(mockRetrieveUserServiceProxy);
    }

    @Test
    public void testRetrieveUser_validRequest_correctResponse() throws IOException {
        Mockito.when(mockRetrieveUserServiceProxy.retrieveUser(validRequest)).thenReturn(successResponse);
